...
public class C01_NewWindow {
    ...
    /*
        ...
        Testin ilerleyen asamalarinda yeniden esli sayfalara donus gorevi varsa
    ...
    public void test01() throws InterruptedException {
        ...
        // amazon sayfasindayken bu window un handle degerini alip kaydetmeliyiz


        String ilkSayfaHandleDegeri=driver.getWindowHandle();

        // yeni bir tab da wisequarter.com a gidin ve gittimizi test edin
        ...
        // ve amazon ana sayfasin acik oldugunu test edin
